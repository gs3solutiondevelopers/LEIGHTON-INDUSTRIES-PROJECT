...
const Complaint = () => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    alert('Your complaint has been submitted. Our team will review it and get in touch.');
  };
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <label htmlFor="productModel" className="block text-sm font-medium text-gray-700">Product Model / Serial Number</label>
              <input 
                type="text" 
                id="productModel"
            ...
            <div>
              ...
              <textarea 
                id="complaint" 
                rows="5"
                {...register("complaint", { required: "Please describe your complaint." })}
                className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
              ></textarea>
